...
<style>
    ...
    .floor-plan { position: relative; width: 100%; aspect-ratio: 4 / 3; background: #f0f0f0; border: 2px solid #333; border-radius: 12px; background-image: radial-gradient(#ccc 1px, transparent 1px); background-size: 20px 20px; }
</style>